    ...
    categories.forEach(category => {
      ...
      <div class="flex flex-col w-full md:flex-row md:max-w-xl lg:max-w-full rounded-lg bg-white shadow-lg">
          ...
          <div class="p-6 flex flex-col justify-start w-full">
              ...
              <div class="grid grid-cols-2 lg:grid-cols-4 justify-between items-center p-6">
              ...
              <button onclick="showNewsDetails('${_id}')" data-bs-toggle="modal" data-bs-target="#exampleModalCenteredScrollable">
